                ...
                <tbody>
                    @foreach( $all_product as $key => $pro)
                        <tr>
                            ...
                            ?>
                                    <a
                                        href="{{ URL::to('/active-product/'.$pro->product_id) }}"><span>Ẩn</span></a>
                                    <?php
                                }elseif($pro->product_status == 1){
                            ?>
                                    <a
                                        href="{{ URL::to('/unactive-product/'.$pro->product_id) }}"><span>Hiện</span></a>
                                    <?php
                                }
                            ?>
                                </span></td>
                            ...
                            <a href="{{URL::to('/edit-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class=""><i
                                ...
                                <a href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit" 
