                ...
                <tbody>
                    @foreach( $coupon as $key => $val)
                        <tr>
                            ...
                            if($val->coupon_condition == 1){
                        ?>
                            Giảm {{number_format($val->coupon_money,0,',','.').' VNĐ'}} %
                                <?php
                            }else{
                        ?>
                            Giảm {{number_format($val->coupon_money,0,',','.').' VNĐ'}} tiền
                                <?php
                            }
                        ?>
                        </span></td>
                            ...
                            <td>
                                <a href="{{URL::to('/delete-coupon/'.$val->coupon_id)}}" class="active styling-edit" 
